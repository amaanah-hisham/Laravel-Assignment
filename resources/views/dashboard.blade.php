            ...
            <div class="col-lg-3">
                <div class="card border-primary mb-3">
                    <div class="card-body text-primary text-center">
                        <h5 class="card-title">{{ $users_counts ?? '--' }}</h5>
...
<div class="nav nav-tabs" id="nav-tab" role="tablist">
        <button class="nav-link active" id="nav-rent-requests-tab" data-bs-toggle="tab" data-bs-target="#nav-rent-requests" type="button" role="tab" aria-controls="nav-rent-requests" aria-selected="true">Rent Requests</button>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                @empty
                                    <div class="alert alert-info" role="alert">
                                        No products found. Add your first product by clicking <a href="{{ route('prod') }}">here</a>
                                    </div>
                                @endforelse
