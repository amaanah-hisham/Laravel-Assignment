                  ...
                  <img src="{{ asset('assets/imgs/slider/admin.png') }}" class="w-80 h-80 rounded-full mx-auto mb-4">
                        ...
                        <h2 class="text-base font-semibold leading-7 text-gray-900">
                         ...
                         <p class="mt-1 text-sm leading-6 text-gray-600">
                             Create product categories for electronic items.
                        </p>
                  </div>
                </div>
            <form action="{{  route('product-category.store') }}" method="post" class="bg-blue-50 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
        @csrf
